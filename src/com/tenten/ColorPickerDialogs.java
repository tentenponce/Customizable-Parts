...
public class ColorPickerDialogs extends Dialog {
    ...
    public ColorPickerDialogs(Context context, OnColorChangedListener listener, int initialColor) {
        super(context);
        mContext = context;
        mListener = listener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		mTransparencyBar.setProgressDrawable(new TextSeekBarDrawable(mContext.getResources(),
                         mContext.getString(R.string.pref_dialog_color_picker_alpha), true));
